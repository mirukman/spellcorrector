...
@Component
public class HangulEnglishKeyTransformer {

    private char[] engHanKeyMap;
    private String[] hanEngKeyMap;

    private final HangulCombinator assembler;

    public HangulEnglishKeyTransformer() {
        assembler = new HangulCombinator();
        initialize();
    }
    ...
    public String transformHangulToEnglish(String hangul) {
        hangul = assembler.decompose(hangul, true);
    ...
    public String transformEnglishToHangul(String english) {
        ...
        return assembler.compose(hangulBuilder.toString());
    }
